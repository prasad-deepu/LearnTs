// Type intersections combine the features of multiple types, allowing all the features to be used and
//Intersections are defined using the ampersand between two or more types.
type Person = {
    id: string,
    name: string,
    city: string
